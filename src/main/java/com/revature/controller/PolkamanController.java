...
import com.revature.aspect.Manager;
...
public class PolkamanController {
	 ...
	 */
	@Manager //custom annotation here for AOP purposes
	@GetMapping(path = "/all", produces = MediaType.APPLICATION_JSON_VALUE)
	public ResponseEntity<List<Polkaman>> findAll(@RequestHeader(name = "auth", required = false) String auth){
		/*
		 * The return value for a method is serialized as JSON.
		 */
		return new ResponseEntity<>(this.polkamanService.findAll(), HttpStatus.OK);
	}
